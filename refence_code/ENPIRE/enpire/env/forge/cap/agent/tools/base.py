...
class ArmState:
    ...
    def __getitem__(self, key: str) -> Any:
        # Dict-style access (``arm["ee_pos"]``) for LLM-generated policy code.
        try:
...
class RobotState:
    ...
    def __getitem__(self, key: str) -> Any:
        # Dict-style access (``state["arms"]["right"]["ee_pos"]``) for
        # LLM-generated policy code; attribute access stays canonical.
        try:
            return getattr(self, key)
        except AttributeError:
            raise KeyError(key) from None
